...
from sklearn.feature_extraction.text import TfidfVectorizer     # use for conversion of text to number for machine learning
...
# intents is the training data
                
# intents = {
#     "greetings": {
#         "patterns" : ['hello','hey','hii','namaste'],
#         "responses" : ['Hello Sir, How are you','Hello, This is Jarvis','Hello Sir!']
#     },
#     "bye" : {
#         "patterns" : ['bye','jao','nikal','band ho'],
#         "responses" : ['Good by sir']
#     }
# }
...
for intent , data in intents.items():
    for patterns in data['patterns']:
        training_data.append(patterns.lower())
